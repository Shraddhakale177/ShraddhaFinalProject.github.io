...
public class MenuItemDaoCollectionImpl implements MenuItemDao {
	...
	public MenuItemDaoCollectionImpl() {
		...
		if (menuItemList == null) {
		    ...
		    MenuItem itemOne = new MenuItem(1L, "Sandwich", 99.00f, true, new DateUtil().convertToDate("15/03/2021"),
					"Main Course", true);
			MenuItem itemTwo = new MenuItem(2L, "Burger", 129.00f, true, new DateUtil().convertToDate("23/13/2017"),
					"Main Course", false);
			MenuItem itemThree = new MenuItem(3L, "pizza", 149.00f, true, new DateUtil().convertToDate("21/08/2023"),
					"Main Course", false);
			MenuItem itemFour = new MenuItem(4L, "French Fries", 57.00f, false,
					new DateUtil().convertToDate("12/12/2020"), "Main Course", true);
			MenuItem itemFive = new MenuItem(5L, "Chocolate Brownie", 32.00f, true,
					new DateUtil().convertToDate("2/12/2022"), "Main Course", true);
